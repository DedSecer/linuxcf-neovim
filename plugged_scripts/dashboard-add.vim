"disable tabline
autocmd FileType dashboard set showtabline=0 | autocmd WinLeave <buffer> set showtabline=1
autocmd FileType dashboard set laststatus=0 | autocmd WinLeave <buffer> set laststatus=1
